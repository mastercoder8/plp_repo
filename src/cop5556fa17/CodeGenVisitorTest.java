...
public class CodeGenVisitorTest implements ImageResources{
	...
	public void image6() throws Exception{
		...
		BufferedImage average = RuntimeLog.globalImageLog.get(2);
		...
		for(int y = 0; y < 1024; y++) {
            for (int x = 0; x < 1024; x++) {
                ...
                int pixel1 = 0x00FFFFFF ^ ImageSupport.getPixel(g, x, y);
                int pixel2 = ImageSupport.getPixel(h, x, y);
                int pixel3 = pixel2 * 3 & 0x00FFFFFF;
                int pixel4 = ImageSupport.getPixel(average, x, y);
                assertEquals(pixel1, pixel2);
                assertEquals(pixel3, pixel4);
            }
        }
//		for(int y = 0; y < 1024; y++) {
//            for (int x = 0; x < 1024; x++) {
//                //int pixelRef = RuntimeFunctions.cart_y(RuntimeFunctions.polar_r(x, y), RuntimeFunctions.polar_a(x, y)); 
//                //ImageSupport.setPixel(ImageSupport.getPixel(loggedImage1, x,y)^Integer.MAX_VALUE,test,x,y);
//                int pixel1 = 3 * ImageSupport.getPixel(h, x, y);
//                int pixel2 = ImageSupport.getPixel(average, x,y);
//                assertEquals(pixel1, pixel2);
//            }
//        }
