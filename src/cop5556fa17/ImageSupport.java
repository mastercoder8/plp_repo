...
public class ImageSupport {
	 ...
	 * @return
	 */
	// public static boolean compareImages(BufferedImage image1, BufferedImage
	// image2) {
	...
	// if (X != image2.getWidth()) {System.out.println("image widths did not
	// match"); return false; }
	// if (Y != image2.getHeight()) {System.out.println("image heights did not
	// match"); return false; }
	// for (int y = 0; y < 20; y++) {
	// for (int x = 0; x < 20; x++) {
	//// if ( getPixel(image1,x,y) != getPixel(image2,x,y)) {
	//// System.out.println("Image comparison failed at (x,y)=("+x+","+y+").
	// Expected "
	//// + getPixel(image1,x,y) + ", was " + getPixel(image2,x,y) );
	//// return false;
	// System.out.println("(x,y)=("+x+","+y+") " + getPixel(image1,x,y) + ", " +
	// getPixel(image2,x,y));
	//// }
	// }
	// }
